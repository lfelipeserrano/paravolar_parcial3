...
package paravolar.test_job_0_1;
...
public class test_job implements TalendJob {
	...
	public static class factStruct implements routines.system.IPersistableRow<factStruct> {
		final static byte[] commonByteArrayLock_PARAVOLAR_test_job = new byte[0];
		static byte[] commonByteArray_PARAVOLAR_test_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PARAVOLAR_test_job.length) {
					if (length < 1024 && commonByteArray_PARAVOLAR_test_job.length == 0) {
						commonByteArray_PARAVOLAR_test_job = new byte[1024];
					} else {
						commonByteArray_PARAVOLAR_test_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PARAVOLAR_test_job, 0, length);
				strReturn = new String(commonByteArray_PARAVOLAR_test_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PARAVOLAR_test_job, 0, length);
				strReturn = new String(commonByteArray_PARAVOLAR_test_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PARAVOLAR_test_job) {
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/felip/Downloads/flights (1).csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/felip/Downloads/flights (1).csv", "ISO-8859-15", ",", "\n", true, 1, 0,
...
// Start of branch "fact"
					...
					if (!((Object) ("C:/Users/felip/Downloads/flights (1).csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Users/felip/Downloads/DimDestination (2).csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/felip/Downloads/DimDestination (2).csv", "ISO-8859-15", ";", "\n", true, 1, 0,
...
// Start of branch "row2"
					...
					if (!((Object) ("C:/Users/felip/Downloads/DimDestination (2).csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "C:/Users/felip/Downloads/DimTimePeriod (2).csv";
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/felip/Downloads/DimTimePeriod (2).csv", "ISO-8859-15", ";", "\n", true, 1, 0,
...
// Start of branch "row5"
					...
					if (!((Object) ("C:/Users/felip/Downloads/DimTimePeriod (2).csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_4 = "C:/Users/felip/Downloads/DimOrigin (1).csv";
					...
					try {
						fid_tFileInputDelimited_4 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/felip/Downloads/DimOrigin (1).csv", "ISO-8859-15", ";", "\n", true, 1, 0,
...
// Start of branch "row3"
					...
					if (!((Object) ("C:/Users/felip/Downloads/DimOrigin (1).csv") instanceof java.io.InputStream)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_5 = "C:/Users/felip/Downloads/DimAirlines (5).csv";
...
// Start of branch "row4"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test_job.class.getClassLoader()
					.getResourceAsStream("paravolar/test_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = test_job.class.getClassLoader()
...
/************************************************************************************************
 * 334915 characters generated by Talend Open Studio for Data Integration on the
 * November 6, 2022 at 7:08:23 PM CST
 ************************************************************************************************/