...
package paravolar.contextjob_0_1;
 ...
 * @status
 */
public class contextJob implements TalendJob {
	...
	private final String jobName = "contextJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(contextJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PARAVOLAR_contextJob = new byte[0];
		static byte[] commonByteArray_PARAVOLAR_contextJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PARAVOLAR_contextJob.length) {
					if (length < 1024 && commonByteArray_PARAVOLAR_contextJob.length == 0) {
						commonByteArray_PARAVOLAR_contextJob = new byte[1024];
					} else {
						commonByteArray_PARAVOLAR_contextJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PARAVOLAR_contextJob, 0, length);
				strReturn = new String(commonByteArray_PARAVOLAR_contextJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PARAVOLAR_contextJob, 0, length);
				strReturn = new String(commonByteArray_PARAVOLAR_contextJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PARAVOLAR_contextJob) {
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final contextJob contextJobClass = new contextJob();

		int exitCode = contextJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = contextJob.class.getClassLoader()
					.getResourceAsStream("paravolar/contextjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = contextJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : contextJob");
		}
...
/************************************************************************************************
 * 40623 characters generated by Talend Open Studio for Data Integration on the
 * November 5, 2022 at 6:20:07 PM CST
 ************************************************************************************************/