...
package paravolar.load_airlines_data_0_1;
...
/**
 * Job: load_airlines_data Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class load_airlines_data implements TalendJob {
	...
	private final String jobName = "load_airlines_data";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					load_airlines_data.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(load_airlines_data.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:gCWbB8QjcNhQ55WQOgd/6hQi7AxKcHnewrp7Zor5NYQRISZeEbu4Z3A4DNhBTN6dozToqspuZaMTRSh9ekEfjoh9IhQ=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "airlines_2022_07.csv";
				...
				Object fileOrStream_tS3Put_1 = "C:/Users/felip/Downloads/airlines (1).csv";
						...
						if (!multiUpload_tS3Put_1) {
							...
							try {
								...
								conn_tS3Put_1.abortMultipartUpload(
										new com.amazonaws.services.s3.model.AbortMultipartUploadRequest("paravolar/raw",
	...
	public static void main(String[] args) {
		final load_airlines_data load_airlines_dataClass = new load_airlines_data();

		int exitCode = load_airlines_dataClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = load_airlines_data.class.getClassLoader()
					.getResourceAsStream("paravolar/load_airlines_data_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = load_airlines_data.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : load_airlines_data");
		}
...
/************************************************************************************************
 * 40562 characters generated by Talend Open Studio for Data Integration on the
 * November 6, 2022 at 6:06:37 PM CST
 ************************************************************************************************/