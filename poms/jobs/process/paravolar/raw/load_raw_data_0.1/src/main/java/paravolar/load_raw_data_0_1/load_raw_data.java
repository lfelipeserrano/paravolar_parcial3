...
package paravolar.load_raw_data_0_1;
 ...
 * @status
 */
public class load_raw_data implements TalendJob {
	...
	private final String jobName = "load_raw_data";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					load_raw_data.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(load_raw_data.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ZEr6qbsxVVccZYxIhRqgSSoLwuEzlIMaQyFq6obAnduTaSH+hjGzhM++bPMSs5WQzjfqU75D1Pbg07FoWYuWcZ2rzvQ=");
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String directory_tFileList_1 = "C:/Users/felip/Downloads/archive/raw";
				final java.util.List<String> maskList_tFileList_1 = new java.util.ArrayList<String>();
				final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>();
				maskList_tFileList_1.add("Flights_2022_*");
					...
					try {
						...
						if (!useStream_tS3Put_1) {
							...
							com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest(
									"paravolar/raw", key_tS3Put_1, inputFile_tS3Put_1)
							...
							class S3StreamUtil {
								...
								public int readFully(final java.io.InputStream input, final byte[] buffer,
										final int offset, final int length) throws java.io.IOException {
									if (length < 0) {
							...
							if (!multiUpload_tS3Put_1) {
								...
								com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.PutObjectRequest(
										"paravolar/raw", key_tS3Put_1, uploadStream_tS3Put_1, objectMetadata_tS3Put_1);
								...
								com.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_tS3Put_1 = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(
										"paravolar/raw", key_tS3Put_1, objectMetadata_tS3Put_1);
								...
								try {
									while (streamHasNext_tS3Put_1) {
										com.amazonaws.services.s3.model.UploadPartRequest uploadRequest_tS3Put_1 = new com.amazonaws.services.s3.model.UploadPartRequest()
												.withBucketName("paravolar/raw").withKey(key_tS3Put_1)
										...
										streamHasNext_tS3Put_1 = (1 == streamUtil_tS3Put_1
												.readFully(sourceStream_tS3Put_1, probeAvailability_tS3Put_1));
									...
									com.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_tS3Put_1 = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(
											"paravolar/raw", key_tS3Put_1, uploadId_tS3Put_1, partTags_tS3Put_1);
									...
									conn_tS3Put_1.abortMultipartUpload(
											new com.amazonaws.services.s3.model.AbortMultipartUploadRequest(
													"paravolar/raw", key_tS3Put_1, uploadId_tS3Put_1));
	...
	public static void main(String[] args) {
		final load_raw_data load_raw_dataClass = new load_raw_data();

		int exitCode = load_raw_dataClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = load_raw_data.class.getClassLoader()
					.getResourceAsStream("paravolar/load_raw_data_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = load_raw_data.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : load_raw_data");
		}
...
/************************************************************************************************
 * 45884 characters generated by Talend Open Studio for Data Integration on the
 * November 5, 2022 at 2:04:11 PM CST
 ************************************************************************************************/