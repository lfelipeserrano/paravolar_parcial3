            ...
            csvSettings_tFileOutputDelimited_2.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_2.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_2.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_2.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_2.length()==0){
                                    headColutFileOutputDelimited_2[0]="timePeriodId";
                                    headColutFileOutputDelimited_2[1]="year";
                                    headColutFileOutputDelimited_2[2]="quarter";
                                    headColutFileOutputDelimited_2[3]="month";
                                    headColutFileOutputDelimited_2[4]="dayOfMonth";
                                    headColutFileOutputDelimited_2[5]="dayOfWeek";
                                    headColutFileOutputDelimited_2[6]="flightDate";
...
row2 = null;			
if(row1.FlightDate == null){
	finder_tUniqRow_1.FlightDate = null;
}else{
	finder_tUniqRow_1.FlightDate = row1.FlightDate.toLowerCase();
}	
...
if(row1.FlightDate == null){
	new_tUniqRow_1.FlightDate = null;
}else{
	new_tUniqRow_1.FlightDate = row1.FlightDate.toLowerCase();
}
...
dimension_tmp.year = row3.Year ;
dimension_tmp.quarter = row3.Quarter ;
dimension_tmp.month = row3.Month ;
dimension_tmp.dayOfMonth = row3.DayofMonth ;
dimension_tmp.dayOfWeek = row3.DayOfWeek ;
dimension_tmp.flightDate = row3.FlightDate ;
	...
	currentComponent="tFileOutputDelimited_2";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_2=new String[7];
                            rowtFileOutputDelimited_2[0]=dimension.timePeriodId == null ? null : String.valueOf(dimension.timePeriodId);
                            rowtFileOutputDelimited_2[1]=dimension.year == null ? null : String.valueOf(dimension.year);
                            rowtFileOutputDelimited_2[2]=dimension.quarter == null ? null : String.valueOf(dimension.quarter);
                            rowtFileOutputDelimited_2[3]=dimension.month == null ? null : String.valueOf(dimension.month);
                            rowtFileOutputDelimited_2[4]=dimension.dayOfMonth == null ? null : String.valueOf(dimension.dayOfMonth);
                            rowtFileOutputDelimited_2[5]=dimension.dayOfWeek == null ? null : String.valueOf(dimension.dayOfWeek);
                            rowtFileOutputDelimited_2[6]=dimension.flightDate == null ? null : dimension.flightDate;
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:J7aee5GBuL5OC0uC23EaLOPlIiXqT3OSw8SUag2T6Da6zbSYLUCe2+6paYPjz+99ficr7oj08IHEDCXuXBbtt3Re/0k=");
...
/************************************************************************************************
 *     433804 characters generated by Talend Open Studio for Data Integration 
