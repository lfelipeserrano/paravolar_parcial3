...
package paravolar.dimdestination_0_1;
...
/**
 * Job: DimDestination Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class DimDestination implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "DimDestination";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				DimDestination.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(DimDestination.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class dimensionStruct implements routines.system.IPersistableRow<dimensionStruct> {
    final static byte[] commonByteArrayLock_PARAVOLAR_DimDestination = new byte[0];
    static byte[] commonByteArray_PARAVOLAR_DimDestination = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PARAVOLAR_DimDestination.length) {
				if(length < 1024 && commonByteArray_PARAVOLAR_DimDestination.length == 0) {
   					commonByteArray_PARAVOLAR_DimDestination = new byte[1024];
				} else {
   					commonByteArray_PARAVOLAR_DimDestination = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PARAVOLAR_DimDestination, 0, length);
			strReturn = new String(commonByteArray_PARAVOLAR_DimDestination, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PARAVOLAR_DimDestination, 0, length);
			strReturn = new String(commonByteArray_PARAVOLAR_DimDestination, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PARAVOLAR_DimDestination) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.airportCode = readInteger(dis);
					...
					this.worldAreaCode = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.airportCode,dos);
					...
					// String
						...
						writeString(this.worldAreaCode,dos);
    ...
    public int compareTo(dimensionStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.destinationId, other.destinationId);
						if(returnValue != 0) {
							return returnValue;
						}
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimDestination.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_2 != null && directory_tFileOutputDelimited_2.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        outtFileOutputDelimited_2.write("destinationId");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("destinationKey");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("destAirportSeqId");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("airportCode");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("cityName");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("stateCode");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("stateName");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("worldAreaCode");
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this._DestAirportID == null) ? 0 : this._DestAirportID.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									if (this._DestAirportID == null) {
										if (other._DestAirportID != null) 
											return false;
								
									} else if (!this._DestAirportID.equals(other._DestAirportID))
...
row2 = null;			
finder_tUniqRow_1._DestAirportID = row1._DestAirportID;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1._DestAirportID = row1._DestAirportID;
...
dimension_tmp.destinationId = Numeric.sequence("DestinationSeq", 1, 1) ;
dimension_tmp.destinationKey = row3._DestAirportID ;
dimension_tmp.destAirportSeqId = row3._DestAirportSeqID ;
dimension_tmp.airportCode = row3._Dest ;
dimension_tmp.cityName = row3._DestCityName ;
dimension_tmp.stateCode = row3._DestState ;
dimension_tmp.stateName = row3._DestStateName ;
dimension_tmp.worldAreaCode = row3._DestWac ;
...
if(dimension != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                            if(dimension.destinationId != null) {
                        sb_tFileOutputDelimited_2.append(
                            dimension.destinationId
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(dimension.destinationKey != null) {
                        sb_tFileOutputDelimited_2.append(
                            dimension.destinationKey
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(dimension.destAirportSeqId != null) {
                        sb_tFileOutputDelimited_2.append(
                            dimension.destAirportSeqId
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(dimension.airportCode != null) {
                        sb_tFileOutputDelimited_2.append(
                            dimension.airportCode
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(dimension.cityName != null) {
                        sb_tFileOutputDelimited_2.append(
                            dimension.cityName
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(dimension.stateCode != null) {
                        sb_tFileOutputDelimited_2.append(
                            dimension.stateCode
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(dimension.stateName != null) {
                        sb_tFileOutputDelimited_2.append(
                            dimension.stateName
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(dimension.worldAreaCode != null) {
                        sb_tFileOutputDelimited_2.append(
                            dimension.worldAreaCode
                        );
                            }
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:TX24wSkSTOzC2Wv50cKe/tN0V1lCg7dI5p+zZwwOiOpBEZiaQX8c+MgOBJ/EZ2FQXDM9hyCkX+SuBcnOSx2X/c/pRQU=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "DimDestination.csv";
	...
	Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimDestination.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final DimDestination DimDestinationClass = new DimDestination();

        int exitCode = DimDestinationClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DimDestination.class.getClassLoader().getResourceAsStream("paravolar/dimdestination_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DimDestination.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DimDestination");
        }
...
/************************************************************************************************
 *     386641 characters generated by Talend Open Studio for Data Integration 
