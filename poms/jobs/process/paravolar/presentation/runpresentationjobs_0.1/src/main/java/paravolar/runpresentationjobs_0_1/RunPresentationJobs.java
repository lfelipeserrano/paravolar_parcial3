...
package paravolar.runpresentationjobs_0_1;
...
/**
 * Job: RunPresentationJobs Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class RunPresentationJobs implements TalendJob {
	...
	private final String jobName = "RunPresentationJobs";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					RunPresentationJobs.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(RunPresentationJobs.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paravolar.get_flights_stage_0_1.get_flights_stage childJob_tRunJob_1 = new paravolar.get_flights_stage_0_1.get_flights_stage();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paravolar.runairlinedimensionjob_0_1.runAirlineDimensionJob childJob_tRunJob_6 = new paravolar.runairlinedimensionjob_0_1.runAirlineDimensionJob();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paravolar.dimdestination_0_1.DimDestination childJob_tRunJob_2 = new paravolar.dimdestination_0_1.DimDestination();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paravolar.dimorigin_0_1.DimOrigin childJob_tRunJob_3 = new paravolar.dimorigin_0_1.DimOrigin();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paravolar.dimtimeperiod_0_1.DimTimePeriod childJob_tRunJob_4 = new paravolar.dimtimeperiod_0_1.DimTimePeriod();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paravolar.flightfact_0_1.FlightFact childJob_tRunJob_5 = new paravolar.flightfact_0_1.FlightFact();
				// pass DataSources
	...
	public static void main(String[] args) {
		final RunPresentationJobs RunPresentationJobsClass = new RunPresentationJobs();

		int exitCode = RunPresentationJobsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = RunPresentationJobs.class.getClassLoader()
					.getResourceAsStream("paravolar/runpresentationjobs_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = RunPresentationJobs.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : RunPresentationJobs");
		}
...
/************************************************************************************************
 * 65504 characters generated by Talend Open Studio for Data Integration on the
 * November 8, 2022 at 11:17:37 PM CST
 ************************************************************************************************/