...
package paravolar.dimairlines_0_1;
...
/**
 * Job: DimAirlines Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class DimAirlines implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "DimAirlines";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(DimAirlines.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class dimensionStruct implements routines.system.IPersistableRow<dimensionStruct> {
    final static byte[] commonByteArrayLock_PARAVOLAR_DimAirlines = new byte[0];
    static byte[] commonByteArray_PARAVOLAR_DimAirlines = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PARAVOLAR_DimAirlines.length) {
				if(length < 1024 && commonByteArray_PARAVOLAR_DimAirlines.length == 0) {
   					commonByteArray_PARAVOLAR_DimAirlines = new byte[1024];
				} else {
   					commonByteArray_PARAVOLAR_DimAirlines = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PARAVOLAR_DimAirlines, 0, length);
			strReturn = new String(commonByteArray_PARAVOLAR_DimAirlines, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PARAVOLAR_DimAirlines, 0, length);
			strReturn = new String(commonByteArray_PARAVOLAR_DimAirlines, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PARAVOLAR_DimAirlines) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/dimAirlines.csv")).getAbsolutePath().replace("\\","/");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "DimAirlines.csv";
	...
	Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/dimAirlines.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final DimAirlines DimAirlinesClass = new DimAirlines();

        int exitCode = DimAirlinesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DimAirlines.class.getClassLoader().getResourceAsStream("paravolar/dimairlines_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DimAirlines.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DimAirlines");
        }
