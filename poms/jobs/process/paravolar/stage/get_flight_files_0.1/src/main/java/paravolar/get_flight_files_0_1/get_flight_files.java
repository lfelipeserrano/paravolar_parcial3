...
package paravolar.get_flight_files_0_1;
...
/**
 * Job: get_flight_files Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class get_flight_files implements TalendJob {
...
public String getMonth(){
	...
	private final String jobName = "get_flight_files";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				get_flight_files.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(get_flight_files.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tS3Get_3_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tS3Get_3_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:m/2A1E7L75a9UuQgXJpGkkEfG5ZZj9pU7YbpHT50VgS85TBr9aVJjkxIrEDY8aDnUTLfcCJMSC6bkzWMdgcdpbZD2YU=");
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Connection_1:OnSubjobOk1", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
							...
							tS3Get_1Process(globalMap); 
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Connection_1:OnSubjobOk2", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PARAVOLAR_get_flight_files = new byte[0];
    static byte[] commonByteArray_PARAVOLAR_get_flight_files = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PARAVOLAR_get_flight_files.length) {
				if(length < 1024 && commonByteArray_PARAVOLAR_get_flight_files.length == 0) {
   					commonByteArray_PARAVOLAR_get_flight_files = new byte[1024];
				} else {
   					commonByteArray_PARAVOLAR_get_flight_files = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PARAVOLAR_get_flight_files, 0, length);
			strReturn = new String(commonByteArray_PARAVOLAR_get_flight_files, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PARAVOLAR_get_flight_files, 0, length);
			strReturn = new String(commonByteArray_PARAVOLAR_get_flight_files, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PARAVOLAR_get_flight_files) {
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/stage_config.txt", "ISO-8859-15","=","\n",true,0,0,
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("paravolar/raw", "Flights_2022_"+(Integer.parseInt(context.month)+1)+".csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_2 = tm_tS3Get_2.download(
			getObjectRequest_tS3Get_2, 
			new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/Flights_2022_"+(Integer.parseInt(context.month)+1)+".csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tS3Get_3";
		...
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_3 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
	...
	try{
		...
		tm_tS3Get_3 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_3)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_3 = new com.amazonaws.services.s3.model.GetObjectRequest("paravolar/stage", "flights.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_3 = tm_tS3Get_3.download(
			getObjectRequest_tS3Get_3, 
			new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/flights_stage"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final get_flight_files get_flight_filesClass = new get_flight_files();

        int exitCode = get_flight_filesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = get_flight_files.class.getClassLoader().getResourceAsStream("paravolar/get_flight_files_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = get_flight_files.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : get_flight_files");
        }
...
/************************************************************************************************
 *     62594 characters generated by Talend Open Studio for Data Integration 
 *     on the November 6, 2022 at 4:55:55 PM CST
 ************************************************************************************************/