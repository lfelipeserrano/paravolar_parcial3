...
package paravolar.first_loda_airlines_0_1;
...
/**
 * Job: first_loda_airlines Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_loda_airlines implements TalendJob {
	...
	private final String jobName = "first_loda_airlines";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_loda_airlines.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_loda_airlines.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:TISLY2ktBiCWtjLXamXr3nJKITNq4n8q3t4RH3ksx84BZY908KWnNNfgVmU3E07D+S+rJ8FA3tyUg30Km7mjVKsU1zY=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "airlines_2022_07.csv";
					final String to_bucket_tS3Copy_1 = "paravolar/stage";
					final String to_key_tS3Copy_1 = "airlines.csv";
	...
	public static void main(String[] args) {
		final first_loda_airlines first_loda_airlinesClass = new first_loda_airlines();

		int exitCode = first_loda_airlinesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_loda_airlines.class.getClassLoader()
					.getResourceAsStream("paravolar/first_loda_airlines_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_loda_airlines.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : first_loda_airlines");
		}
...
/************************************************************************************************
 * 39061 characters generated by Talend Open Studio for Data Integration on the
 * November 8, 2022 at 10:58:14 PM CST
 ************************************************************************************************/