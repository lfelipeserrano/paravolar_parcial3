...
package paravolar.first_load_flights_0_1;
...
/**
 * Job: first_load_flights Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_load_flights implements TalendJob {
	...
	private final String jobName = "first_load_flights";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_flights.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_flights.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:p4Ne9eIeIH2PLOTWKYI7T+QytK7VJJBNDx6JNEXJ6i+V1tGqgC+qVBGM52aZvc7OQHA6yulCA8xGwXt9Lsg4i3hqH+g=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_bucket_tS3Copy_1 = "paravolar/raw";
					final String from_key_tS3Copy_1 = "Flights_2022_1.csv";
					final String to_bucket_tS3Copy_1 = "paravolar/stage";
					final String to_key_tS3Copy_1 = "flights.csv";
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Copy_1:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/PARAVOLAR/config.txt";
	...
	public static void main(String[] args) {
		final first_load_flights first_load_flightsClass = new first_load_flights();

		int exitCode = first_load_flightsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_flights.class.getClassLoader()
					.getResourceAsStream("paravolar/first_load_flights_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_flights.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : first_load_flights");
		}
...
/************************************************************************************************
 * 50026 characters generated by Talend Open Studio for Data Integration on the
 * November 8, 2022 at 10:58:51 PM CST
 ************************************************************************************************/